...
<div>
    ...
    <div class="mt-4">
        ...
        <input type="text" name="sponsorship_details" class="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm" placeholder="Details of sponsorships">
    </div>

    <div class="mt-4">
        <label class="block text-sm font-medium text-gray-700">Provide an estimated budget for your study period:</label>
        <textarea name="budget_details" class="form-textarea mt-1 block w-full rounded-md border-gray-300 shadow-sm" rows="4" placeholder="Detail your expected expenses"></textarea>
    </div>
</div>
