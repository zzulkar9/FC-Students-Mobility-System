        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6 border border-gray-300">
                <div class="text-gray-900">
                    ...
                    <p class="mt-1 text-sm"><span class="font-bold">Matric Number:</span> {{ Auth::user()->matric_number }}</p>
                    <p class="mt-1 text-sm"><span class="font-bold">Upcoming Semester:</span> {{ Auth::user()->getCurrentSemester() }}</p>
            ...
            @if (isset($applicationForm))
                <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6 border border-gray-300 col-span-1 md:col-span-2">
                    <div class="text-gray-900">
                        ...
                        <table class="min-w-full w-full mt-2 text-sm mb-4">
                            ...
                            <tbody>
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="border px-4 py-2 text-center">{{ $applicationForm->approval_status ? 'Approved' : 'Pending' }}</td>
                        ...
                        @if (isset($incompleteTabs))
                            <div class="bg-yellow-50 p-4 rounded-md mt-4">
                                <div class="text-yellow-800">
                                    <p class="text-sm">
                                        The following tabs are not fully filled yet: {{ implode(', ', $incompleteTabs) }}. Please complete them.
                                    </p>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="bg-yellow-100 p-4 rounded-lg mt-4">
                            @if ($latestComment)
                                <div class="mb-4">
                                    <p class="text-sm"><span class="font-bold">Commenter:</span> {{ $latestComment->user->name }}</p>
                                    <p class="text-sm"><span class="font-bold">Date:</span> {{ $latestComment->created_at->format('d-m-Y H:i') }}</p>
            ...
            @if (isset($allCourses))
                <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6 col-span-1 md:col-span-3 border border-gray-300">
                    <div class="text-gray-900">
