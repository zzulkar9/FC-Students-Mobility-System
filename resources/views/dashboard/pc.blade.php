            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6 border border-gray-300">
                    <div class="text-gray-900">
                        ...
                        <a href="{{ route('study-plans.index') }}" class="text-blue-600 hover:text-blue-900 font-semibold mt-4 block">Manage Study Plans</a>
                    </div>
                </div>
                <!-- Inbound Students -->
                <div class="bg-white overflow-hidden shadow-lg rounded-lg p-6 border border-gray-300">
                    <div class="text-gray-900">
                        ...
                        <a href="{{ route('inbound-students.list') }}" class="text-blue-600 hover:text-blue-900 font-semibold mt-4 block">Manage Inbound Students</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const overviewChart = new Chart(ctxOverview, {
                type: 'bar',
                data: {
                    labels: ['Outbound Applications', 'Study Plans', 'Inbound Students'],
                    datasets: [{
                        label: 'Count',
                        data: [{{ $applications->total() }}, {{ $studentsWithStudyPlans->count() }}, {{ $inboundStudents->total() }}],
                        backgroundColor: [
                            'rgba(54, 162, 235, 0.6)',
                            'rgba(75, 192, 192, 0.6)',
