        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="mb-4">
                <form action="{{ route('timetables.index') }}" method="GET">
                    ...
                    <input type="text" id="search_course" name="search" class="w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" placeholder="Search by course code or name" value="{{ request('search') }}">
                </form>
            </div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mt-4">
                        {{ $timetables->appends(['search' => request('search')])->links() }}
                    </div>
                </div>
            </div>
        </div>
