        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-xl font-semibold text-center mb-6">Edit Course</h1>
                    <form action="{{ route('courses.update', $course->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Course Code Input -->
                            <div class="mb-4">
                                <label for="course_code" class="block font-medium text-sm text-gray-700">Course
                                    Code</label>
                                <input type="text" name="course_code" id="course_code"
                                    value="{{ old('course_code', $course->course_code) }}" required
                                    class="rounded-md shadow-sm border-gray-300 mt-1 block w-full" />
                                @error('course_code')
                            ...
                            <!-- Course Name Input -->
                            <div class="mb-4">
                                <label for="course_name" class="block font-medium text-sm text-gray-700">Course
                                    Name</label>
                            ...
                            <div class="mb-4">
                                <label for="year_semester" class="block font-medium text-sm text-gray-700">Year and
                                    Semester</label>
                            ...
                            <!-- Course Credit Input -->
                            <div class="mb-4">
                                <label for="course_credit" class="block font-medium text-sm text-gray-700">Course
                                    Credit</label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="rounded-md shadow-sm border-gray-300 mt-1 block w-full">{{ old('description', $course->description) }}</textarea>
                            @error('description')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center mt-4 justify-center space-x-4">
                            ...
                            <button onclick="window.history.back();" type="button"
                                class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">Go
                                Back</button>
                        </div>
