                                    ...
                                    @if (!$isPastSemester($yearSemester))
                                        <details class="semester-block mb-4" data-semester="{{ $yearSemester }}">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <textarea id="remark_{{ $yearSemester }}" name="remarks[{{ $yearSemester }}]" rows="2" class="form-textarea mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ $plans->first()->remark }}</textarea>
                                            </div>
                                        </details>
                                    @endif
                                @endforeach
